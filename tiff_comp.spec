...
"""
PyInstaller spec file for TIFF Compiler GUI application.
Builds a standalone Linux executable with all dependencies bundled.

Usage: pyinstaller tiff_comp.spec
"""
